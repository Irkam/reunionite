...
urlpatterns = patterns('',
    ...
    url(r'^meetings/(?P<polls_offset>\d+)/$', meetings.MeetingsView.as_view(), name="meetings"),
    url(r'^meeting/create$', create_meeting.CreateMeetingView.as_view(), name="create"),
    url(r'^meeting/(?P<poll_id>\d+)$', meeting.MeetingView.as_view(), name="meeting"),
    url(r'^meeting/(?P<poll_id>\d+)/results$', results.MeetingResultsView.as_view(), name="results"),
    url(r'^meeting/(?P<poll_id>\d+)/edit$', edit_meeting.EditMeetingView.as_view(), name="edit"),
